...
axis2[0, 1].plot(tf, np.array(N2), label='(E2), r2 = 0.4', color='black' , linestyle='dashed')
axis2[0, 1].legend()
...
axis2[1, 0].plot(tf, np.array(N1), label='(E1), r1 = 1.2', color='red', linestyle='dashed')
axis2[1, 0].plot(tf, np.array(N2), label='(E2), r2 = 1', color='black' , linestyle='dashed')
axis2[1, 0].legend()
...
axis2[1, 1].plot(tf, np.array(N1), label='(E1), r1 = 0.7', color='red', linestyle='dashed')
axis2[1, 1].plot(tf, np.array(N2), label='(E2), r2 = 0.4', color='black' , linestyle='dashed')
axis2[1, 1].legend()
